 ...
 */
package keystrokesmod.client.clickgui.font;
...
public abstract class FontLoaders {
    ...
    public static Font getFont(int size) {
        Font font;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("client/ali.ttf")).getInputStream();
